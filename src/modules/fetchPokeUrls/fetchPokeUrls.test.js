...
describe("fetchPokeUrls", () => {
  ...
  it("fetches pokemon data and calls setChosenPokemon for each URL", async () => {
    const pokeApiUrls = ["https://mock.com/mock/1", "https://mock.com/mock/2"];
    ...
    expect(globalThis.fetch).toHaveBeenCalledWith(pokeApiUrls[0], {
      mode: "cors",
    });
    expect(globalThis.fetch).toHaveBeenCalledWith(pokeApiUrls[1], {
      mode: "cors",
    });
